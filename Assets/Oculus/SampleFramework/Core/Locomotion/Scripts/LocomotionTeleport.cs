...
public class LocomotionTeleport : MonoBehaviour
{
    ...
    public NuclidDictionary nuclidDictionary;
    public Decayrow decayrow;

    public bool isFloorScene;
	...
	public void DoTeleport()
	{
        ...
        Vector3 destPosition = new Vector3(destTransform.position.x - LocomotionController.CameraRig.centerEyeAnchor.localPosition.x, destTransform.position.y, destTransform.position.z - LocomotionController.CameraRig.centerEyeAnchor.localPosition.z);
        
        if (isFloorScene)
        {
            KeyClassDict nuclidKey = nuclidDictionary.RayIntersection(destTransform.position + Vector3.up * 0.5f, -Vector3.up);
            if (nuclidKey != null)
            {
                Nuklidclass nuclidElement;
                if (nuclidDictionary.nucliddata.TryGetValue(nuclidKey, out nuclidElement))
                {
                    decayrow.checkSelected(nuclidKey);
                    destPosition = new Vector3(nuclidElement.Prefab.GetComponent<NuclidPrefabElements>().TeleportTarget.position.x - LocomotionController.CameraRig.centerEyeAnchor.localPosition.x, nuclidElement.Prefab.GetComponent<NuclidPrefabElements>().TeleportTarget.position.y, nuclidElement.Prefab.GetComponent<NuclidPrefabElements>().TeleportTarget.position.z - LocomotionController.CameraRig.centerEyeAnchor.localPosition.z);
                }
            }
        ...
        //LocomotionController.CameraRig.centerEyeAnchor.position = new Vector3(0, LocomotionController.CameraRig.centerEyeAnchor.position.y, 0);
